        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              cloud solutions, we bring your ideas to life with precision and
              creativity.
            </p>
          </motion.div>
              ...
              >
                ...
                <div className="relative p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div
                      className={`w-12 h-12 rounded-xl bg-gradient-to-br ${stat.color} flex items-center justify-center mb-4 transform group-hover:scale-110 transition-transform duration-300 relative`}
                    >
                      <div>
