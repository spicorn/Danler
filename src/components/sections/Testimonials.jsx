        ...
        <div className="relative max-w-4xl mx-auto">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 h-full flex flex-col">
                  ...
                  <div className="flex justify-center mb-6">
                    <motion.div
                      ...
                      className="w-16 h-16 bg-primary-100 dark:bg-primary-900/20 rounded-full flex items-center justify-center"
                    >
                  ...
                  <motion.p
                    ...
                    className="text-lg text-gray-600 dark:text-gray-300 text-center mb-8 flex-grow"
                  >
          ...
          <div className="flex justify-center space-x-4 mt-8">
            <motion.button
              ...
              className="w-12 h-12 bg-white dark:bg-gray-800 rounded-full shadow-lg flex items-center justify-center hover:bg-primary-50 dark:hover:bg-gray-700 transition-colors"
            >
